    ...
    <div class="container mt-sm-5 my-1">
        <div class="question ml-s m-5 pl-sm-5 pt-2">
            ...
            <div class="ml-md-3 ml-sm-3 pl-md-5 pt-sm-0 pt-3" id="options">
                <label class="options">{{$trashed_question->option_one}} <input type="radio" {{($trashed_question->answer == $trashed_question->option_one) ? "checked" : "disabled"}} name="radio-{{$trashed_question->id}}"> <span class="checkmark"></span> </label>
                <label class="options">{{$trashed_question->option_two}} <input type="radio" {{($trashed_question->answer == $trashed_question->option_two)? "checked" : "disabled"}}  name="radio-{{$trashed_question->id}}"> <span class="checkmark"></span> </label> 
                <label class="options">{{$trashed_question->option_three}} <input type="radio" {{($trashed_question->answer == $trashed_question->option_three)? "checked" : "disabled"}}  name="radio-{{$trashed_question->id}}"> <span class="checkmark"></span> </label> 
                <label class="options">{{$trashed_question->option_four}} <input type="radio" {{($trashed_question->answer == $trashed_question->option_four)? "checked" : "disabled"}}  name="radio-{{$trashed_question->id}}" > <span class="checkmark"></span> </label> 
            </div>
            <div class="py-2 h5"><b>Answer: </b> {{$trashed_question->answer}}</div>
            <div class="py-2 h5"><b>Chapter: </b> {{$trashed_question->chapter_number}}</div>
            <div class="py-2 h5"><b>Difficulty: </b> {{$trashed_question->difficulty}}</div>
           <div class="py-2 h5"><a class="btn btn-danger" href="{{route('questions.hdelete',['user' => $user->id, 'subject' => $subject, 'question' => $trashed_question->id ])}}"><i class="fas fa-trash-alt"></i> Delete </a></div> &nbsp; &nbsp; 
           <div class="py-2 h5"><a class="btn btn-danger" href="{{route('questions.restore',['user' => $user->id, 'subject' => $subject, 'question' => $trashed_question->id ])}}"><i class="fas fa-trash-alt"></i> Restore </a></div> &nbsp; &nbsp; 
        </div>
    </div>
    <br>
    @endforeach
